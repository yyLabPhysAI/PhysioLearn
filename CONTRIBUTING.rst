...
Welcome to ``physiolearn`` contributor's guide.
...
If you experience bugs or general issues with ``physiolearn``, please have a look
...
You can help improve ``physiolearn`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``physiolearn`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``physiolearn``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n physiolearn python=3 six virtualenv pytest pytest-cov
    conda activate physiolearn
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/physiolearn.git
    cd physiolearn
...
#. Install |pre-commit|_::
   ...
   ``physiolearn`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/physiolearn
.. _issue tracker: https://github.com/<USERNAME>/physiolearn/issues
.. <-- end -->
